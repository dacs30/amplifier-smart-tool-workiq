...
The image selected in `site.json` is copied from this repository at build time.
...
The vendored theme keeps Work IQ's help text aligned with its manifest and CLI.
The Website workflow validates the site by building it.
